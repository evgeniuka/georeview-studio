...
Full method, a findings table and the ranked top 20 are in [`portfolio/case_study.md`](portfolio/case_study.md). A deeper, fully recomputed analysis — score anatomy, ranking-robustness tests and data-quality findings, generated by one stdlib script with the SQL that produced them — is in [`docs/analysis/kfar_saba_crossing_access_report.md`](docs/analysis/kfar_saba_crossing_access_report.md) (queries in [`sql/`](sql/)).
